...
<head>
    ...
    <title>uneo - <?php 
    if ($flag1 == true){ 
    echo $productName; } else { echo ('not found');}?></title>
</head>
    ...
    <header class="top-header">
            ...
            <div class="banner">
                <div class="banner-format text-center py-4" style="background: #ffefe6">
                    ...
                    <p>
                        <span><a href="./index.php" class="home-link">Home</a></span> / <span><a class="category-title"
                                href="./collection.php?categoryName=<?= $productMain['category_name']?>"><?= $productMain['category_name']?></a></span>
                    </p>
                </div>
            </div>
        </header>
                    ...
                    <div class="col-lg-6">
                        <div class="product-img text-center">
                            <div class="img-product-item main-img"
                                style="background: url('<?= $productMain['pro_image']?>') no-repeat; height: 530px; background-size: cover;">
                            </div>
                            <div class="product-item-type mobile-hidden mb-4 mt-4">
                                <div class="row">
                                    <div class="col-3">
                                        <img src="<?= $productMain['pro_image']?>"
                                            alt="" class="img-fluid sub-img">
                                    </div>
                                    <?php 
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-3 mb-sm-3"> 
                                        <form action="./cart-interaction.php" method='get'>
                                            ...
                                            <input type="number" name="product-qty" id="product-qty" min="1" value="1">
                                            <button class="btn-addcart" type="submit" value="addcart" name="addcart">Add To Cart</button>
                                        </form>
                                    </div>    
                                    <div class="col-lg-6 col-md-3 mb-sm-3"> 
                                        <a href='./cart-interaction.php?productName=P<?=  $productMain['name']?>' class="btn-buynow">Buy It
                                            Now</a>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="comments">
            <div class="container my-5">
                <div class="product-selected text-center my-3">
                    <div class="row">
                        <div class="col-lg-6 col-sm-6 d-flex justify-content-end">
                            <button class="btn-product-selected" id="btnDesc">Description</button>
                        </div>
                        <div class="col-lg-6 col-sm-6 d-flex justify-content-start">
                            <button class="btn-product-selected" id="btnReviewForm">Reviews (<span
                                    class="review-qty"><?= count($allReviews)?></span>)</button>
                        </div>
                    </div>
                </div>
                    ...
                    <div id="review-slide">
                            ...
                            <div class="content-form">
                                   <form action="./up-review.php" method="get" target="_blank">
                                    ...
                                    <input type="text" name="customer-name" id="customer-name"
                                        placeholder="Enter your name" required value=<?php if ($flag == true) {echo $userInfo['username'];} else {echo '';}?>>
                                    <input type="text" name="customer-email" id="customer-email"
                                        placeholder=<?php if ($flag == true) {echo $userInfo['username'].'@gmail.com';} else {echo ('Enter your email');}?> required>
                                    <br>
                        ...
                        <div id="reviewView">
                                ...
                                <div class="review-view-item pt-2 text-dark">
                                    <h4 style="color: #797979;">Name: <?= $value['reviewer_name'] ?></h4>
