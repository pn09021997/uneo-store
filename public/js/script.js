...
$(document).ready(function () {
    ...
    if ($('#priceRange')) {
        ...
        $('#priceRange').change(() => {
            ...
            const urlListProductByPriceRange = "./public/ajax/getListProductByPriceRange.php";
    ...
    if ($('#sort-selected')) {
        ...
        $('#sort-selected').change(() => {
            ...
            $.ajax({
                ...
                data: { columnName: arrCriteria[0], criteria: arrCriteria[1], categoryName: categoryName },
                dataType: 'JSON',
                success: function (data) {
                    var products = data.map(element => {
                        return element;
        ...
        function renderCategoryItem(products, val) {
            ...
            if (products.length != 0) {
                ...
                $('#categories-info').html(`
                    ...
                    `);
                $('#categories-info').attr('href', `./collection.php?categoryName=${products[0].category_name}`);
                ...
                `);
                $('#categories-info').attr('href', `./collection.php?categoryName=${val}`);
                $('#productList').empty();
                $('#productList').html('<div class="col-12 text-center text-info" style="animation: popIn .4s;"><h3>No Item Yet !!!</h3></div>')
            }
        }
    }
    ...
    if ($('.sub-img')) {
        ...
        function setMainImg(number_MainImg) {
            let arrImg_Split = arrMainImg[number_MainImg].style.backgroundImage.split('"');
            arrImg_Split[1] = txt;
            arrMainImg[number_MainImg].style.backgroundImage = arrImg_Split.toString().replaceAll(',', '"');
    ...
    if ($('#blog-title')) {
        ...
        let arrBlogs = [{
            ...
            content: 'The first thing you need to do is sit down and set your goals. Diana...'
        },
        {
            ...
            date: 'February 9, 2020',
            content: 'Even though most of Utah has fully opened up – we’ve been having fun doing...'
        },
        {
            ...
            date: 'February 9, 2020',
            content: 'Hey guys! I wanted to share the ‘Best of’ multiple categories from the Nordstrom Sale,...'
        },];
                    ...
                    switch (index) {
                        case 0:
                            ...
                            $('.product-layout').each((index, item) => {
                                $(item).attr('class', arrProductLayout.toString().replaceAll(',', ' '));
    ...
    if ($('.banner-slide')) {
        ...
        function setContentOfBanner(arrProduct, count) {
            ...
            $('.banner-slide').css('background-image', `url(${arrProduct[count].img})`);
            $('.page').html('0' + (count + 1));
