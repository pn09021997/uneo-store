...
<body>
    ...
    <div class="wrapper">
        <header class="top-header">
            ...
            <!-- Banner -->
            <div class="banner" style="background: url('https://cdn.shopify.com/s/files/1/0076/1708/5530/files/breadcrumb_1512x.jpg?v=1611677285') no-repeat center center / cover fixed;">
                <div class="banner-format">
                    <div class="banner-info">
                        <p class="main-title"><?= $categoryName ?></p>
                        <p>
                            <span><a href="./index.php" class="home-link">Home</a></span> / <span class="category-title"><?= $categoryName ?></span>
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-3">
                        <div class="tools">
                            <div class="price-range">
                                ...
                                <input type="range" id="priceRange" min="<?= $min ?>" max="<?= $max ?>" value="<?= $max ?>" style="width: 100%;">
                                ...
                                <ul>
                                    <li>
                                        <button class="color-style">
                                            <img src="https://cdn.shopify.com/s/files/1/0076/1708/5530/t/4/assets/color-1.png?v=14312182983328405479" alt="" class="img-fluid img-color-picked">
                                        </button>
                                    </li>
                                    <li>
                                        <button class="color-style">
                                            <img src="https://cdn.shopify.com/s/files/1/0076/1708/5530/t/4/assets/color-5.png?v=14312182983328405479" alt="" class="img-fluid img-color-picked">
                                        </button>
                                    </li>
                                    <li>
                                        <button class="color-style">
                                            <img src="https://cdn.shopify.com/s/files/1/0076/1708/5530/t/4/assets/color-6.png?v=14312182983328405479" alt="" class="img-fluid img-color-picked">
                                        </button>
                                    </li>
                                    <li>
                                        <button class="color-style">
                                            <img src="https://cdn.shopify.com/s/files/1/0076/1708/5530/t/4/assets/color-7.png?v=14312182983328405479" alt="" class="img-fluid img-color-picked">
                                        </button>
                                    </li>
                                    <li>
                                        <button class="color-style">
                                            <img src="https://cdn.shopify.com/s/files/1/0076/1708/5530/t/4/assets/color-8.png?v=14312182983328405479" alt="" class="img-fluid img-color-picked">
                                        </button>
                                    </li>
                                </ul>
                            </div>
