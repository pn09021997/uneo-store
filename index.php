...
<body>
    <div class="wrapper">
            ...
            <div class="banner">
                <div class="container-fluid">
                    <div class="slide-pagination">
                        <span class='page'>01</span> / <span class="total-page"
                            style="font-size: 1rem; font-weight: 500;">2</span>
                    </div>
                    <div class="banner-slide"
                        style="background: url('https://cdn.shopify.com/s/files/1/0076/1708/5530/files/s1.jpg?v=1607016667') no-repeat; height: 650px; background-size: cover; ">
                        <div class="product-info">
                            <div class="mb-5 collection">
                        ...
                        <div class="mobile-hidden">
                            <span class="banner-slide-controls1" id="btn-slide-prev1"><i
                                    class="fas fa-chevron-left"></i></span>
                            <span class="banner-slide-controls1" id="btn-slide-next1"><i
                                    class="fas fa-chevron-right"></i></span>
                        </div>
                        <div class="banner-slide-controls2">
                            <ul style="list-style: none;">
                                <li><button class="banner-slide-controls2" id="btn-slide-prev2"></button></li>
                                <li><button class="banner-slide-controls2" id="btn-slide-next2"></button></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6 col-sm-12 my-3">
                        <a href="./collection.php?categoryName=<?= $value['category_name']?>" class="category-item">
                            <div class="img-category"
                                style="background: url('<?= $value['category_img']?>') no-repeat; background-size: cover;height: 300px;">
            ...
            <div class="container-fluid">
                <div class="categories">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="categories-items d-flex justify-content-end mt-sm-5 mt-md-3">
                    ...
                    <div class="row" id='categories-result'>
                        <div class="col-lg-6">
                            <a href="./collection.php?categoryName=All" class="product-item" id='categories-info'>
                                ...
                                ?>
                                    style="background: url('<?= $txt[0]['category_img']?>'); background-size: cover; height: 780px;">
        ...
        <div class="discover">
            <div class="container">
                <div
                    style="background: url('https://cdn.shopify.com/s/files/1/0076/1708/5530/files/b1_1920x.jpg?v=1609084589') no-repeat; height: 750px; background-size: cover;">
                    <div class="discover-content text-white">
                        ...
                        <img src="https://cdn.shopify.com/s/files/1/0076/1708/5530/files/home1_image_layout_1.png?v=1609088119"
                            alt="" class="img-fluid">
                        <br>
                ...
                <div class="blog-item mobile-hidden">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="blog-item-content">
                                <div class="blog-item-header">
                                    <img src="https://cdn.shopify.com/s/files/1/0076/1708/5530/articles/blog11_1728x.jpg?v=1609344075"
                                        style="height: 415px; width: 420px;" alt="" class="img-fluid">
                                    <h4 class="title my-3">
                        ...
                        <div class="col-lg-4">
                            <div class="blog-item-content">
                                <div class="blog-item-header">
                                    <img src="https://cdn.shopify.com/s/files/1/0076/1708/5530/articles/b8_900x.jpg?v=1608651515"
                                        style="height: 415px; width: 420px;" alt="" class="img-fluid">
                                    <h4 class="title my-3">
                                ...
                                <div class="blog-item-body">
                                    <p><span><a href="#">FAMILY</a>, <a href="#">FASHION</a>, <a href="#">SALE</a>, <a
                                                href="#">SUMMER</a></span> / <span>February 9,
                                            2020</span></p>
                                    <hr style="width: 90px;" class="mt-5 mb-4">
                        ...
                        <div class="col-lg-4">
                            <div class="blog-item-content">
                                <div class="blog-item-header">
                                    <img src="https://cdn.shopify.com/s/files/1/0076/1708/5530/articles/b5_900x.jpg?v=1608651517"
                                        style="height: 415px; width: 420px;" alt="" class="img-fluid">
                                    <h4 class="title my-3">
                ...
                <div class="blog-item-moblie">
                    <div class="blog-item-content">
                        <div class="blog-item-header">
                            <div class="slide">
                                <img src="https://cdn.shopify.com/s/files/1/0076/1708/5530/articles/b5_900x.jpg?v=1608651517"
                                    style="height: 450px; width: 100%;" alt="" class="img-fluid" id="blog-img">
                                <span class="slide-controls" id="btn-prev"><i
                                        class="far fa-arrow-alt-circle-left"></i></span>
                                <span class="slide-controls" id="btn-next"><i
                        ...
                        <div class="blog-item-body">
                            <p><span id="blog-categories"><a href="#">SALE</a>, <a href="#">WEAR</a></span> / <span
                                    id="blog-date">February 9,
                                    2020</span></p>
                            <hr style="width: 90px;" class="mt-5 mb-4">
