                ...
                <div class="contact">
                    <div class="row">
                        <div class="col-lg-4">
                            ...
                            <p class="my-4 mr-5">2593 Timbercrest Road, Chisana, Alaska Badalas
                                United State,</p>
                        ...
                        <div class="col-lg-4">
                            ...
                            <ul style="list-style: none;">
                                <li class="list-item"><a href="#">Promotions, new products and sales. Directly to your
                                        inbox.</a></li>
                                <li class="list-item">
                                    <input type="text" placeholder="Your email" class="input-email"> <button
                                        class="btn-subscribe">SUBSCRIBE</button>
                                </li>
                                <li class="list-item">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-lg-6 d-flex justify-content-end">
                            <img src="https://cdn.shopify.com/s/files/1/0076/1708/5530/files/paypal_400x.png?v=1609092737"
                                alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
