...
<head>
    ...
    <style>
        .cart-footer .checkout-form input, textarea, button{
            width: 100%;
            outline: none;
            border: none;
        ...
        .cart-footer .checkout-form input:focus, .cart-footer .checkout-form textarea:focus{
                            ...
                            <tr>
                                <td>
                                    <div class="product-item" style="display: flex;">
                                        <a href="./product-detail.html?productName=<?= $arrProduct['name']?>" target="_blank">
                                ...
                                <td>
                                    <div class="product-info">
                                        <a href="./product-detail.html?productName=<?= $arrProduct['name']?>" class="product-name"><?= $arrProduct['name']?></a>
                                        <br>
                        ...
                        <div class="row">
                            <div class="col-lg-6 checkout-form">
                                ...
                                <form action="./checkout.php" method="POST">
                                    ...
                                    <textarea name="instruction" id="instructions" rows="5"
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-body">
                                                    <div class="container py-5">
                                                        ...
                                                        <button type='submit' class='btn btn-dark mt-3 btn-block btn-signin py-3'>CHECK OUT</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-6 d-flex justify-content-end text-right">
                                <div class="checkout">
                                    ...
                                    <p>You're saving <span class="price-total-txt">$194.11</span>
